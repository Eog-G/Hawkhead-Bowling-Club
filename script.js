        ...
        if (nextThreeEvents.length === 0) {
            newsGrid.innerHTML = `
                <div class="no-events-card">
                    ...
                    <h3 class="no-events-title">No Upcoming Events Scheduled</h3>
                    <p class="no-events-text">It's quiet for now! Please check back later for new events, competitions, and social nights.</p>
                </div>
            `;
            return;
        }
